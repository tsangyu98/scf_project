    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enterprise', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='recruits', to='employment.Enterprise', verbose_name='企业ID')),
            ],
            options={
                'verbose_name': '职位',
