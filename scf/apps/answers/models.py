...
class Label(models.Model):
    ...
    label_icon = models.ImageField(null=True, default=None, verbose_name="标签图 片")
    # 标签的关注者
...
class Question(models.Model):
    ...
    replytime = models.DateTimeField(null=True, default=None, verbose_name="回复日 期")
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name="questions", default=None,
                             verbose_name="用户ID")
...
class Reply(models.Model):
    ...
    createtime = models.DateTimeField(auto_now_add=True, null=True, verbose_name="创建日期")
    updatetime = models.DateTimeField(auto_now=True, null=True, verbose_name="修 改日期")
    useful_count = models.BigIntegerField(null=True, default=0, verbose_name="有用 数")
    unuseful_count = models.BigIntegerField(null=True, default=0, verbose_name="无用数")
    parent = models.ForeignKey('self', on_delete=models.SET_NULL, related_name='subs', null=True, blank=True,
                               verbose_name='父评论')
    problem = models.ForeignKey(Question, on_delete=models.CASCADE, related_name="replies", default=None,
                                verbose_name="问题ID")
