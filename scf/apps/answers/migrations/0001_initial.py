    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='subs', to='answers.Reply', verbose_name='父评论')),
                ('problem', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, related_name='replies', to='answers.Question', verbose_name='问题ID')),
            ],
            options={
                'verbose_name': '回答',
