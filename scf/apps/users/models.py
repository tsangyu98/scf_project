...
class User(AbstractUser):
    ...
    realname = models.CharField(max_length=100, null=True, verbose_name='真实名 称')
    ...
    website = models.CharField(max_length=100, null=True, verbose_name='个人网 站')
    city = models.CharField(max_length=100, null=True, verbose_name='现居城市')
    address = models.CharField(max_length=100, null=True, verbose_name='联系住 址')
    update_date = models.DateTimeField(auto_now=True, verbose_name="更新时间")  # 我的粉丝有谁
