...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('answers', '0002_auto_20191219_0715'),
        migrations.swappable_dependency(settings.AUTH_USER_MODEL),
        ('toutiao', '0001_initial'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='article',
            name='channel',
            field=models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='articles', to='toutiao.Channel', verbose_name='所属频道'),
        ),
        migrations.AddField(
            model_name='article',
        ...
        migrations.AddField(
            model_name='article',
            name='labels',
            field=models.ManyToManyField(related_name='articles', to='answers.Label'),
        ),
        migrations.AddField(
            model_name='article',
            name='user',
